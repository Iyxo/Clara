...
-- Clara.TopBar.ScrollingFrame.UIListLayout
...
-- Clara.TopBar.DropShadowHolder.DropShadow
...
-- Clara.TopBar.TopBar.UIGradient
...
-- Clara.TopBar.ProfileMenu.PlayerProfile
...
-- Clara.TopBar.ProfileMenu.PlayerProfile.UICorner
DRR["e"] = Instance.new("UICorner", DRR["d"]);
DRR["e"]["CornerRadius"] = UDim.new(0.30000001192092896, 0);

-- Clara.TopBar.ProfileMenu.PlayerProfile.UIGradient
...
-- Clara.TopBar.ProfileMenu.PlayerProfile.ImageLabel
...
-- Clara.TopBar.ProfileMenu.PlayerProfile.ImageLabel.UIAspectRatioConstraint
DRR["11"] = Instance.new("UIAspectRatioConstraint", DRR["10"]);
DRR["11"]["AspectRatio"] = 0.9842342734336853;

-- Clara.TopBar.ProfileMenu.PlayerProfile.ImageLabel.UICorner
DRR["12"] = Instance.new("UICorner", DRR["10"]);
DRR["12"]["CornerRadius"] = UDim.new(100, 0);

-- Clara.TopBar.ProfileMenu.PlayerProfile.ImageLabel.UIGradient
...
-- Clara.TopBar.ProfileMenu.PlayerProfile.TextLabel
...
-- Clara.TopBar.ProfileMenu.UIListLayout
...
-- Clara.TopBar.ProfileMenu.Clock.TextLabel
...
-- Clara.TopBar.ProfileMenu.Title
...
-- Clara.TopBar.ProfileMenu.Title.TextLabel
...
-- Clara.TopBar.TopBarClose.idk.UIGradient
...
-- Clara.TopBar.TopBarClose.UIAspectRatioConstraint
DRR["24"] = Instance.new("UIAspectRatioConstraint", DRR["1f"]);


-- Clara.TopBar.TopBarClose.ImageLabel
...
-- Clara.TopBar.TopBarClose.ImageLabel.UIAspectRatioConstraint
DRR["26"] = Instance.new("UIAspectRatioConstraint", DRR["25"]);
DRR["26"]["AspectRatio"] = 0.9836804866790771;

-- Clara.TopBar.UIAspectRatioConstraint
...
-- Clara.MainBar.DropShadowHolder.DropShadow
...
-- Clara.Folder.TabReserved.UIListLayout
...
-- Clara.Folder.TabButtonReserved
...
-- Clara.Folder.TabButtonReserved.Frame.TextLabel
...
-- Clara.Folder.TabButtonReserved.Frame.UIListLayout
...
-- Clara.Folder.TabButtonReserved.UIGradient
...
-- Clara.Folder.TabButtonReserved.ImageLabel
...
-- Clara.Folder.TabButtonReserved.ImageLabel.UIAspectRatioConstraint
DRR["3a"] = Instance.new("UIAspectRatioConstraint", DRR["39"]);
DRR["3a"]["AspectRatio"] = 0.9842342734336853;

-- Clara.Folder.TabButtonReserved.UIListLayout
...
-- Clara.Folder.Dropdown.Description
...
-- Clara.Folder.Dropdown.DropdownBar
...
-- Clara.Folder.Dropdown.DropdownBar.UICorner
DRR["43"] = Instance.new("UICorner", DRR["42"]);
DRR["43"]["CornerRadius"] = UDim.new(0.20000000298023224, 0);

-- Clara.Folder.Dropdown.DropdownBar.UIGradient
...
-- Clara.Folder.Dropdown.DropdownBar.UIStroke
DRR["45"] = Instance.new("UIStroke", DRR["42"]);
DRR["45"]["Color"] = Color3.fromRGB(40, 45, 62);

-- Clara.Folder.Dropdown.DropdownBar.Icon
...
-- Clara.Folder.Dropdown.DropdownBar.Icon.UIAspectRatioConstraint
DRR["47"] = Instance.new("UIAspectRatioConstraint", DRR["46"]);


-- Clara.Folder.Dropdown.DropdownBar.Open
...
-- Clara.Folder.Dropdown.DropdownBar.Trigger
...
-- Clara.Folder.Dropdown.Box.UIGradient
...
-- Clara.Folder.Dropdown.Box.ScrollingFrame.UIListLayout
...
-- Clara.Folder.Keybind.Description
...
-- Clara.Folder.Slider.ActualSlider
...
-- Clara.Folder.Slider.ActualSlider.UIStroke
DRR["65"] = Instance.new("UIStroke", DRR["62"]);
DRR["65"]["Color"] = Color3.fromRGB(0, 255, 39);

-- Clara.Folder.Slider.ActualSlider.Fill
...
-- Clara.Folder.Slider.ActualSlider.Fill.UICorner
DRR["67"] = Instance.new("UICorner", DRR["66"]);
DRR["67"]["CornerRadius"] = UDim.new(0.20000000298023224, 0);

-- Clara.Folder.Slider.ActualSlider.Fill.UIGradient
...
-- Clara.Folder.Slider.ActualSlider.Trigger
...
-- Clara.Folder.Slider.ActualSlider.Trigger.UICorner
DRR["6a"] = Instance.new("UICorner", DRR["69"]);
DRR["6a"]["CornerRadius"] = UDim.new(0.20000000298023224, 0);

-- Clara.Folder.Slider.ActualSlider.Trigger.UIGradient
...
-- Clara.Folder.Slider.ActualSlider.Title
...
-- Clara.Folder.Slider.Description
...
-- Clara.Folder.Textbox.Description
...
-- Clara.Folder.Textbox.TextboxBar
...
-- Clara.Folder.Textbox.TextboxBar.UIStroke
DRR["76"] = Instance.new("UIStroke", DRR["73"]);
DRR["76"]["Color"] = Color3.fromRGB(40, 45, 62);

-- Clara.Folder.Textbox.TextboxBar.ActualTextbox
...
-- Clara.Folder.Toggle.Description
...
-- Clara.Folder.Toggle.Label.UIStroke
...
-- Clara.Folder.Toggle.Label.Label
...
-- Clara.Folder.Button.Description
