-- Load the Clara library from the GitHub repository Library
local ClaraLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/AZYsGithub/Clara-UI-Library/main/Clara.lua"))()

-- Create a new window and set its title and theme
local window = ClaraLibrary:Load("Clara!", "Default")

-- Create the first tab with an image ID
local tab1 = ClaraLibrary.newTab("Tab 1", "ImageIdHere")
...
local tab2 = ClaraLibrary.newTab("Tab 2", "ImageIdLogoHere")
